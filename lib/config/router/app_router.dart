...
import '../../presentation/action/presentation/action_one_client_screen.dart';
...
final appRouter = GoRouter(routes: [
  ...
  GoRoute(
    path: '/actionOneSingleClientScreen',
    builder: (context, state) => const ActionOneSingleClientScreen(),
  ),
]);
